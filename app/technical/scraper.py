...
class TechnicalQuestionScraper:
    def __init__(self, headless=False):
        ...
        self.TOPIC_URLS = [
            ...
            "https://www.indiabix.com/computer-science/database-systems/",
    ...
    def extract_question_data(self, question_element):
        try:
            ...
            return {
                ...
                "answer": "",
                "explanation": ""
            } if question_text and len(options) >= 2 else None
    ...
    def save_questions(self, questions, filename="app/technical/question_bank.json"):
        if not questions:
    ...
    def run_scraping(self):
        print("Starting Technical Question Scraper...")
...
def main():
    scraper = TechnicalQuestionScraper(headless=False)
